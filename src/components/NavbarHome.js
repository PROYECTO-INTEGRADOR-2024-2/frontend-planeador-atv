  ...
  return (
    <nav className='bg-slate-500 p-2'>
      <div className="container mx-2 flex justify-between items-center">
        ...
        <div className='flex items-center  align-content:justify-end text-xl'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff" className="size-8">
          ...
          <div className="text-white">
            ...
            <span className="mr-2">Hola, Joaquin</span>

          </div>

          {/*Menu*/}
          <div className="relative">
            <button onClick={abrirMenu} className="text-white focus:outline-none">
            ...
            {MenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1">
                ...
                <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mis Proyectos</a>
